  ...
  return (
    <div className='navbar'>
            <div className='navbar_container'>
                <img src={logo} alt="" className='nav_logo' onClick={() => handleNavClick(0)} />
                ...
                <div ref={navRef} className="nav_items responsive_nav">
                    ...
                    <span onClick={() => handleNavClick(1)} className={getNavItemClass(1)}>Design</span>
                    <span onClick={() => handleNavClick(2)} className={getNavItemClass(2)}>Modular</span>
                    <span onClick={() => handleNavClick(3)} className={getNavItemClass(3)}>AI</span>
                    <span onClick={() => handleNavClick(4)} className={getNavItemClass(4)}>Case Studies</span>
                    <span onClick={() => handleNavClick(5)} className={getNavItemClass(5)}>Contact Us</span>
                    <a
                    target="_blank"
